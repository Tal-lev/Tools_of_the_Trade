...
OverwriteTableKeys( TraitData, {
	...
	{
		Icon = "JarlUlsfark-Tools_of_the_Trade\\InfestedCerberus2Icon",
		ShowInHUD = true,
		CustomLabel = 
		{
			DisplayType = "RoomValue",
			Key = "Copy_InfestedCerberustwo",
			Text = "Copy_EmptyText"
		},
        PropertyChanges = 
        {
	...
	InfestedCerberusTwoCopyTwoDisplayBoon = 
	{
		Icon = "JarlUlsfark-Tools_of_the_Trade\\InfestedCerberus2Icon",
		ShowInHUD = true,
		CustomLabel = 
	...
	{
		Icon = "JarlUlsfark-Tools_of_the_Trade\\Prometheus2Icon",
		ShowInHUD = true,
		CustomLabel = 
		{
			DisplayType = "RoomValue",
			Key = "Copy_Prometheustwo",
			Text = "Copy_EmptyText"
		},
        PropertyChanges = 
        {
	...
	PrometheusTwoCopyTwoDisplayBoon = 
	{
		Icon = "JarlUlsfark-Tools_of_the_Trade\\Prometheus2Icon",
		ShowInHUD = true,
		CustomLabel = 
